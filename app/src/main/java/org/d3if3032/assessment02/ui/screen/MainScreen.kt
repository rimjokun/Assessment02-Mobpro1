...
import org.d3if3032.assessment02.navigation.Screen
import org.d3if3032.assessment02.ui.theme.Assessment02Theme
import org.d3if3032.assessment02.util.SettingsDataStore
...
@Composable
fun ListItem(data: Data, onClick: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() }
...
@Composable
fun GridItem(data: Data, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
